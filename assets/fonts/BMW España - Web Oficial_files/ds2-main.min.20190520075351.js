...
define( 'ds2-main',
    ...
    function ($, Animation, _, componentInitializer) {
        ...
        proto.initTrigger = function () {
            ...
            this.animation.smoothScrollingToAnchorByUrl();
        ...
        proto.init = function () {
          ...
          this.initializeGcdmOnVCOForm();
            ...
            setTimeout(function(){
                if(window.ds2configurator && sessionStorage.getItem('gcdm-accessToken')){
        ...
        proto.addGcdmMarkup = function () {
            ...
            var lightboxReadyEvent,
                ...
                if (typeof window.Event === 'function') {
                    lightboxReadyEvent = new Event('ds2-lightbox-ready');
                }
                else {
